var roomData = [
    ...
    // Room 1 - Death by lava
    {
        ...
        currentLoot: [],
        actionResponses: {},
        onEnter: function(){playerCharacter[currentCharacter].kill();}
    },
    // Room 3
    {
        ...
        onExit: function(){roomData[2].currentEnemies.forEach(function(e){
    ...
    // Room 4
    {
        ...
        actionResponses: {"sacrifice": {
                ...
                func: function(){playerCharacter[currentCharacter].kill()}
            }
        }
    }
]